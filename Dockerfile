...
# Step 3: `wrangler login` or `wrangler config` (https://dash.cloudflare.com/profile/api-tokens) 
# Step 3a: tutorial for wrangler config
# Step 3b: npm i (nvm install 14.16.0 -> nvm use 14.16.0)
# Step 3c: npm run deploy (make sure to FULLY integrate cloudflare account)
